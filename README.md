# [SOLVED] Lighthouse-Ci-Failing-When-Running-2nd-Test-Due-To-Eperm-Iss
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/lighthouse-ci-failing-when-running-2nd-test-due-to-eperm-iss)
>
...
Try running Lighthouse with elevated privileges or using a different temporary directory to resolve the EPERM error.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/lighthouse-ci-failing-when-running-2nd-test-due-to-eperm-iss)**
